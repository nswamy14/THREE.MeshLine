  ...
  MeshLine.prototype.setPoints = function(points, wcb) {
    ...
    this.aopacity = [];
      ...
      let l = points.length;
        ...
        this.aopacity[j * 2 + 0] = o;
        this.aopacity[j * 2 + 1] = o;
			}
		} else {
      let l = points.length;
			for (var j = 0; j < l; j += 3) {
  ...
  MeshLine.prototype.process = function() {
    ...
    if (!this._attributes || this._attributes.position.count !== this.positions.length) {
      this._attributes = {
        ...
        aopacity: new THREE.BufferAttribute(new Float32Array(this.aopacity), 2)
      }
    } else {
      ...
      this._attributes.aopacity.copyArray(new Float32Array(this.aopacity))
      this._attributes.aopacity.needsUpdate = true
    }
    ...
    this.setAttribute('aopacity', this._attributes.aopacity)
